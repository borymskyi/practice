...
//        return (str, i) -> {
//            StringBuilder result = new StringBuilder("");
//            result.append(String.valueOf(str).repeat(Math.max(0, i)));
//            return new String(result);
//        };
...
//        return (str, n) -> str.repeat(n);
    ...
    public static IntUnaryOperator boundedRandomIntSupplier() {
        return (i) -> ThreadLocalRandom.current().nextInt(0, i);
    }
    ...
    public static UnaryOperator<Function<String, String>> composeWithTrimFunction() {
        return (Function<String, String> function) -> function.compose(String::trim);
    }
    ...
    public static Consumer<Runnable> newThreadRunnableConsumer() {
        return (Runnable runnable) -> new Thread(runnable).start();
    }
...
//        BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> result = (IntUnaryOperator function, IntPredicate predicate) -> {
//            IntUnaryOperator function2 = (i) -> {
//                return predicate.test(i) ? function.applyAsInt(i) : i;
//            };
//
//            return function2;
//        };
...
//        return result;
        ...
        return (intUnaryOperator, intPredicator) -> {
            return i -> {
                if (intPredicator.test(i)) {
...
//        return (Map<String, IntUnaryOperator> nameAndFunc, String name) -> {
//            return nameAndFunc.get(name) != null ? nameAndFunc.get(name) : IntUnaryOperator.identity();
//        };

        return (nameAndFunc, name) -> nameAndFunc.get(name) != null ? nameAndFunc.get(name) : IntUnaryOperator.identity();
